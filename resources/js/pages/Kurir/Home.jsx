...
/* ── Design tokens ────────────────────────────────────────────
   Palette: deep navy base, cool slate surface, blue accent.
   Signature: left-border "pulse" indicator on active rows —
   a motif borrowed from route trackers and logistics UIs.
─────────────────────────────────────────────────────────────── */
const T = {
    bg:       "#060D1F",
    surface:  "#0C1529",
                    ...
                    <div style={{
                        ...
                        <div style={{ position: "relative", zIndex: 1 }}>
                            ...
                            <div style={{ fontSize: "22px", fontWeight: 800, color: T.text, letterSpacing: "-.5px", lineHeight: 1.2 }}>
                                {menunggu > 0
                                    ? <>{menunggu} pengiriman <span style={{ color: "#60A5FA" }}>menunggu</span> Anda</>
                                    : <>Semua pengiriman <span style={{ color: T.green }}>selesai</span> </>
                                }
                            </div>
                        ...
                        <div style={{
                            ...
                            background: T.card, border: `0.5px solid ${T.borderMd}`,
                            color: T.sub, fontSize: "13px", fontWeight: 600,
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: "12px", color: T.muted, marginTop: "2px" }}>
                                    Daftar pesanan yang ditugaskan kepada Anda
                                </div>
                            </div>
                            <div style={{
                                    ...
                                    {orders.length === 0 ? (
                                        ...
                                        orders.map((o, idx) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    {/* signature: left pulse bar for active deliveries */}
