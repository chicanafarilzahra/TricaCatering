...
export default function RuteHariIni({
  ...
  const selesai = locations.filter(
      ...
      >
        ...
        >
         ...
         {/* MAP CARD */}
            ...
            >
                Maps Rute Pengiriman
            </h3>

            <div
                style={{
                width: "100%",
                height: "350px", // tinggi map
                borderRadius: "16px",
                overflow: "hidden",
                }}
            >
                <MapContainer
                center={locations.length ? [locations[0].lat, locations[0].lng] : [-6.90389, 107.61861]} // default center
                zoom={13}
